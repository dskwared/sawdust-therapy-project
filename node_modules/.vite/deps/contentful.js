...
var getIdsFromUrn = function getIdsFromUrn2(urn) {
  ...
  var _urn$match = urn.match(regExp), _urn$match2 = _slicedToArray2(_urn$match, 4), _ = _urn$match2[0], spaceId = _urn$match2[1], _urn$match2$ = _urn$match2[2], environmentId = _urn$match2$ === void 0 ? "master" : _urn$match2$, entryId = _urn$match2[3];
...
function normalizeSelect(query) {
  ...
  return _objectSpread3(_objectSpread3({}, query), {}, {
...
function createContentfulApi(_ref) {
  ...
  async function getEntry(id) {
    ...
    try {
      const response = await this.getEntries(_objectSpread4({
        "sys.id": id
      }, query));
  ...
  async function sync() {
    ...
    switchToEnvironment(http);
    return pagedSync(http, query, _objectSpread4({
      resolveLinks,
      removeUnresolved
    }, options));
  }
...
function createClient(params) {
  ...
  const config = _objectSpread5(_objectSpread5({}, defaultConfig), params);
